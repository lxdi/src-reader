...
processjava = subprocess.Popen('java -Dspring.profiles.active=prod -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=5006 -jar %s' % warPath, shell=True)
